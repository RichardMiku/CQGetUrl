...
namespace Native.App.Export
{
	...
	{	
		...
		{	
			 ...
			 * Function: _menuA	
			 */	
			if (AppData.UnityContainer.IsRegistered<IMenuCall> ("Settings"))	
			{	
				Menu_menuAHandler += AppData.UnityContainer.Resolve<IMenuCall> ("Settings").MenuCall;	
			}	
		...
		{	
			...
			{	
				CQMenuCallEventArgs args = new CQMenuCallEventArgs (AppData.CQApi, AppData.CQLog, "Settings", "_menuA");	
